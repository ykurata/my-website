                ...
                <Fragment>
                  ...
                  <Fade>
                    ...
                    <div className="col-lg-6 description">
                      <h2>Expense Manager&nbsp;&nbsp;<span className="badge badge-pill badge-danger">New</span></h2>
                      <h5>NodeJS / Express / React (Redux) / Postgres</h5>
                      <p>This is an application for tracking your income and expenses.</p>
                      <ul>
                        <li className="list">Authentication with JSON Web Token.</li>
                  ...
                  <Fade>
                    ...
                    <div className="col-lg-6 description">
                      ...
                      <ul>
                        <li className="list">Authentication with JSON Web Token.</li>
                        <li className="list">Create new ads with multiple images.</li>
                        <li className="list">Search items either by the item's name or category.</li>
                  ...
                  <Fade>
                    ...
                    <div className="col-lg-6 description">
                      ...
                      <ul className="mt-2">
                        <li className="list">Authentication with JSON Web Token.</li>
                        <li className="list">Create new recipes with images.</li>
                        <li className="list">Search recipes either by the dish names or ingredients.</li>
                        <li className="list">View recipes from user profiles.</li>
                  ...
                  <Fade>
                    ...
                    <div className="col-lg-6 description">
                      ...
                      <ul>
                        ...
                        <li className="list">Search dog sitters by location.</li>
                  ...
                  <Fade>
                    ...
                    <div className="col-lg-6 description">
                      ...
                      <ul className="mt-2">
                        ...
                        <li className="list">Create a profile and new projects with positions.</li>
